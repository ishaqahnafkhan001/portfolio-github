            ...
            <div className="max-w-4xl mx-auto">
                    ...
                    ${isOpen ? 'bg-indigo-600 text-white' : 'bg-slate-100 text-slate-500'}`}>
                                ...
                                <AnimatePresence>
                                    {isOpen && (
                                        ...
                                        >
                                            <div className="px-6 pb-6 md:px-8 md:pb-8 text-slate-500 leading-relaxed">
                                                {faq.answer}
                                            </div>
                                        </motion.div>
                                    )}
                ...
                <div className="mt-16 text-center">
                    <p className="text-slate-600">
                        ...
                        <a href="#" className="font-bold text-indigo-600 hover:text-indigo-800 underline underline-offset-4 decoration-2">
