...
const ProductGrid = () => {
    const products = [
        ...
        },
        {
            ...
            save: "SAVE 30%",
            popular: true, // This triggers the highlight
            benefits: [
    ...
    return (
        <section className="relative py-24 px-4 md:px-8 bg-slate-50 overflow-hidden">
            ...
            <div
                className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-indigo-100/40 via-transparent to-transparent pointer-events-none"/>
            <div
                className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,_var(--tw-gradient-stops))] from-purple-100/40 via-transparent to-transparent pointer-events-none"/>
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="text-center max-w-3xl mx-auto mb-20">
                    <h2 className="text-4xl md:text-5xl font-extrabold text-slate-900 tracking-tight mb-6">
                        Simple Pricing, <span
                        className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600">Powerful Results</span>
                    </h2>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                    {products.map((product, index) => (
                        <div key={product.id} className={`relative group ${product.popular ? 'lg:-mt-8' : ''}`}>
                            ...
                            {/* POPULAR GLOW (Behind the card) */}
                            {product.popular && (
                                <div
                                    className="absolute -inset-[3px] bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-[2.2rem] opacity-40 blur-lg group-hover:opacity-70 transition-opacity duration-500"/>
                            )}
                            ...
                            >
                                ...
                                {product.popular && (
                                    <div className="absolute -top-4 left-1/2 -translate-x-1/2">
                                        <span
                                            className="bg-slate-900 text-white text-[10px] font-bold px-4 py-1.5 rounded-full uppercase tracking-widest shadow-lg flex items-center gap-1.5 ring-4 ring-slate-50">
                                ...
                                <div className="mb-8 text-center border-b border-slate-100 pb-8">
                                    ...
                                    <div className="flex flex-col items-center justify-center">
                                        <div className="flex items-center gap-2 mb-1">
                                            <span
                                                className="text-slate-400 line-through text-sm font-medium">{product.originalPrice}</span>
                                            <span
                                                className="text-[10px] font-bold text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded-full border border-emerald-100">
                                                {product.save}
                                            </span>
                                        </div>
                                ...
                                <div className="space-y-3 mt-auto">
                                    <button className={`w-full py-4 px-6 rounded-xl text-sm font-bold shadow-md transition-all transform duration-200 active:scale-[0.98]
                                        ${product.popular
                                    ...
                                    <button
                                        ...
                                        <a href={product.demo} target="_blank">View Demo</a> <ArrowRight size={14}/>
                                    </button>
                                </div>
